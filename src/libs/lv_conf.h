...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(roboto_bold_20) \
                               LV_FONT_DECLARE(roboto_mono_bold_20) \
                               LV_FONT_DECLARE(roboto_extrabold_80) \
                               LV_FONT_DECLARE(roboto_42) \
                               LV_FONT_DECLARE(roboto_76) \
...
#define LV_THEME_DEFAULT_FONT_SMALL         &roboto_bold_20
#define LV_THEME_DEFAULT_FONT_NORMAL        &roboto_bold_20
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &roboto_bold_20
#define LV_THEME_DEFAULT_FONT_TITLE         &roboto_bold_20
